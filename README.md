[//]: # (References)
[//]: # (\bibliography{virtualPatient/references.bib})
...
1) We provide 30 virtual patients, modified from *the glucose-insulin system* \cite{dalla2007meal}, which is the open source part of the DMMS.R and T1DM simulators developed by The Epsilon
