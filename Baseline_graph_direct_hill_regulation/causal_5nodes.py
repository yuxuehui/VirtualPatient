...
class CausalGraph:
    def __init__(self,
        ...
        self.nodes[2].val = 0.0
        self.nodes[3].val = 0.0
        self.nodes[4].val = 0.0
    ...
    def calculate(self):
        ...
        """
        delta = np.zeros(N)
        delta[1] = - self.nodes[2].val * 0.9 + self.nodes[0].val * 0.5
        delta[2] = 0.9 * self.nodes[3].val - 0.5 * self.nodes[2].val
        delta[3] = 0.9 * self.nodes[4].val - 0.01 * self.nodes[3].val
